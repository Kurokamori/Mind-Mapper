...
@onready var _name_label: Label = %DesktopLanHostNameLabel
@onready var _detail_label: Label = %DesktopLanHostDetailLabel
@onready var _local_label: Label = %DesktopLanHostLocalLabel
@onready var _pull_button: Button = %DesktopLanHostPullButton
@onready var _push_button: Button = %DesktopLanHostPushButton
@onready var _sync_button: Button = %DesktopLanHostSyncButton
